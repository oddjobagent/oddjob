...
- **Static dashboard import** at the top of `commands/serve.ts` (`import dashboardHtml from "../../../dashboard/src/index.html"`). Static, not dynamic, because `bun build --compile` needs static imports to embed the HTML bundle. Removing the import is the future "headless build" toggle.
